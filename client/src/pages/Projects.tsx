...
const Projects = () => {
    ...
    const [isGenerating, setIsGenetrating] = useState(true)
    ...
    const fetchProject = async () => {
        try {
            ...
            setIsGenetrating(data.project.current_code ? false : true)
            setLoading(false)
        } catch (error: any) {
    ...
    return project ? (
        <div className="flex flex-col h-screen w-full bg-gray-900 text-white">
            ...
            <div className="flex-1 flex overflow-auto">
                <Sidebar isMenuOpen={isMenuOpen} project={project} setProject={(p) =>
                    setProject(p)} isGenerating={isGenerating} setIsGenerating={setIsGenetrating} />
        ...
        (
            <div className="flex items-center justify-center h-center">
                <p className="text-2xl front-medim text-gray-200">Unable to load project!</p>
            </div>
        )
}
