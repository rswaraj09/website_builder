...
const Sidebar = ({ isMenuOpen, project, isGenerating, setIsGenerating, setProject }: SidebarProps) => {
                ...
                >
                  ...
                  <div className='flex items-center justify-between'>
                    {project.current_version_index === ver.id ? (
                      ...
                      <button onClick={()=>handleRollback(ver.id)} className="px-3 py-1 rounded-md text-x5 bg-indio-500 hover:bg-indigo-600 text-white">Roll back to this version</button>
                    )}
